...
export const ActionBox = ({ icon, title, description, accentColor }: ActionItem & { accentColor: string }) => {
  return (
...
export const PartyCorporateWidget = () => {
  const actions: ActionItem[] = [
    { icon: '➕', title: 'Party Management', description: 'Register new corporate entities and business clients into the core system.' },
    { icon: '👤', title: 'User Management', description: 'Create and provision primary administrator accounts for corporate clients.' },
    { icon: '🔓', title: 'Party Account Access', description: 'Map and authorize specific bank accounts to corporate profiles.' },
    { icon: '🔐', title: 'User Account Access', description: 'Manage individual employee permissions for assigned corporate accounts.' },
    { icon: '📊', title: 'Limit Management', description: 'Set daily, monthly, and per-transaction financial ceilings for entities.' },
    { icon: '⚙️', title: 'Workflow & Rule Management', description: 'Define multi-level approval hierarchies for corporate transactions.' },
    { icon: '👥', title: 'User Group Management', description: 'Segment corporate users into functional groups for bulk permissions.' },
    { icon: '🔑', title: 'Party Admin Management', description: 'Establish global system policies and internal check-and-balance steps.' }
  ]
...
export  const AdminUserWidget = () => {
  const actions: ActionItem[] = [
    { icon: '🔑', title: 'User Management', description: 'Setup internal bank operator, auditor, and operational admin accounts.' },
    { icon: '🛡️', title: 'User Group Management', description: 'Configure internal bank roles, clearance levels, and department tags.' },
    { icon: '🔄', title: 'Workflow & Rule Management', description: 'Establish global system policies and internal check-and-balance steps.' }
  ]
