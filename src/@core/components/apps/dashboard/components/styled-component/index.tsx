...
export const StyledCarouselCard = styled(Box)(({ theme }) => ({
  ...
  color: "#fff",
  background: `linear-gradient(115deg, ${theme.palette.customColors.deep} 0%, ${theme.palette.customColors.mid} 48%, ${theme.palette.customColors.bright} 78%, ${theme.palette.customColors.gold} 145%)`,
  minHeight: 232,
  display: "flex",
  ...
  "& .MuiTypography-root[class*='colorTextSecondary']": {
